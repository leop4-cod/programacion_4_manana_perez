...
class CentralRadio : CanalComunicacion {
    ...
    override fun emitir(n: NotificacionTransporte): Boolean {
        ...
        println("  [RADIO] → Comunicando con vehiculo ${n.unidadId}")
        return true
    }
}
...
fun main() {
    ...
    listOf(
        NotificacionTransporte.PantallaAnden(5, "FUN-202"),
        NotificacionTransporte.MensajeConductor("FUN-101", "Desvío por tráfico en la Av. Amazonas"),
