...
class PantallaPaso1User extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> _fetchUser() async {
    final res = await http.get(
      Uri.parse('https://jsonplaceholder.typicode.com/familiares/1'),
    );
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Nombre: ${familiar['name']}',
                      style: const TextStyle(fontSize: 14, color: Colors.grey)),
                  const SizedBox(height: 8),
                  
                  Text(
                    familiar['email'] as String,
                  ...
                  Chip(
                    label: Text(familiar['website']),
                    backgroundColor: (familiar['website'] as String).isNotEmpty
                        ? Colors.green[100]
                        : Colors.orange[100],
                  ),
                ],
